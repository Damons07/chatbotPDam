...
if not huggingfacehub_api_token:
    st.error(
        "Error: No se encontró el token de API de Hugging Face Hub. Asegúrate de configurar la variable de entorno 'HUGGINGFACEHUB_API_TOKEN'.")
    st.stop()
...
def main():
    ...
    if 'generated' not in st.session_state:
        st.session_state['generated'] = ["¡Hola! Soy tu asistente. ¿En qué puedo ayudarte?"]
